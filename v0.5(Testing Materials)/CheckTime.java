...
public class CheckTime
{
	...
	public static void listFilesForFolder(final File folder,int swap)
	{
		...
		if(swap==0)
		{
			// Use LZ77_HuffmanDeCompressor.exe for Defflate Algorithm
			// Use HuffmanDeCompressor.exe for Huffman Algorithm
			// Use ShannonFanoDeCompressor.exe for Shannon Fano Algorithm
			
			parameters[0]="C://Users/Anim/Desktop/v0.5/LZ77_HuffmanDeCompressor.exe";
