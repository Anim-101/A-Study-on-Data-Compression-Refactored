...
public class CheckRatio
{
	...
	public static void listFilesForFolder(final File folder,int swap)
	{
		...
		if(swap==0)
		{
			// Use LZ77_HuffmanCompressor.exe for Defflate Algorithm
			// Use HuffmanCompressor.exe for Huffman Algorithm
			// Use ShannonFanoCompressor.exe for Shannon Fano Algorithm
			
			parameters[0]="C://Users/Anim/Desktop/v0.5/LZ77_HuffmanCompressor.exe";
